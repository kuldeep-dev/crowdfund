        ...
        <div class="box box-primary">
            ...
            <?= $this->Form->create($user, ['id' => 'user-form', 'enctype' => 'multipart/form-data']) ?>
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="exampleInputPassword1">Paypal Id</label>
                  <?php echo $this->Form->control('paypal_id', [ 'type'=>'text','class' => 'form-control', 'label' => false, 'disabled' => 'disabled']); ?>
                </div>
                ...
                <div class="form-group">
                  ...
                  <?php echo $this->Form->control('country', ['class' => 'form-control', 'label' => false]); ?>
                </div>
                ...
                <div class="form-group">
                  ...
                  <?php echo $this->Form->control('company_id', ['type'=>'text', 'class' => 'form-control', 'label' => false]); ?>
                </div>
