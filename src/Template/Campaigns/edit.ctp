			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="tab-content-outer">
                        <?= $this->Form->create($campaign, ['id' => 'invest-form', 'enctype' => 'multipart/form-data' , 'class' => 'invest-form']) ?>
											...
											<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 m-auto">		
												<div class="form-wrap">
													<div class="form-group">
														...
														<input type="text" id="" class="form-control" name="name" value="<?php echo $campaign['name']; ?>" placeholder="Project Hanks">
													...
													<div class="form-group">
														...
														<input type="text" id="" class="form-control" name="facebook_url" value="<?php echo $campaign['facebook_url']; ?>" placeholder="https://www.facebook.com/">
													...
													<div class="form-group">
														...
														<textarea id="" class="form-control" name="facebook_message" value="" placeholder="Message"><?php echo $campaign['facebook_message']; ?></textarea>
													...
													<div class="form-group">
														...
														<input type="text" id="" class="form-control" name="twitter_url" value="<?php echo $campaign['twitter_url']; ?>" placeholder="https://www.twitter.com/">
													...
													<div class="form-group">
														...
														<textarea id="" class="form-control" name="twitter_message" value="" placeholder="Message"><?php echo $campaign['twitter_message']; ?></textarea>
													...
													<div class="form-group form-check">
														<label class="form-check-label">
															<input type="checkbox" id="" class="form-check-input" name="term_and_condition" value="1" <?php if ($campaign['term_and_condition'] == 1) echo 'checked'; ?>>
													...
													<div class="form-group form-check form-radio">
														<input type="radio" id="" class="form-check-input" name="business_advisor" value="1" <?=$campaign['business_advisor']==1 ? "checked" : ""?>>
														<span class="custom-radio"></span>
														<label class="form-check-label">Yes</label>
													</div>
													<div class="form-group form-check form-radio">
														<input type="radio" id="" class="form-check-input" name="business_advisor" value="0" <?=$campaign['business_advisor']==0 ? "checked" : ""?>>
														<span class="custom-radio"></span>
													...
													<div class="form-group form-check form-radio">
														<input type="radio" id="" class="form-check-input" name="org_id" value="<?php echo $org['id']; ?>" <?=$campaign['org_id'] == $org['id']? "checked" : ""?>>
														<span class="custom-radio"></span>
													...
													<div class="form-group form-check form-radio">
														<label class="form-check-label">
                                                            ...
                                                            <?php foreach ($campaign['campaigncategories'] as $row) if ($row['cat_id'] == $cat['id']) echo 'checked'; ?>
                                                            >
															<span class="custom-check"></span>
															<?php echo $cat['name']; ?>
														</label>
													...
													<div class="form-group">
														...
														<input type="text" id="" class="form-control" name="ppt_link" value="<?php echo $campaign['ppt_link']; ?>" placeholder="Enter URL">
													...
													<div class="form-group">
														<div class="row">
															<div class="xs-12 col-sm-12 col-md-6 col-lg-6">
																<div class="image">
                                                                    <img class="pptthumbimg" src="<?php echo $this->request->webroot; ?>images/campaign/<?php echo ($campaign['ppt_thumbnail'] != '') ? $campaign['ppt_thumbnail'] : 'no-image.jpg' ?>" alt="Image">
                                                                </div>
																<div class="btn-file">
												...
												<div class="form-wrap">
													<div class="form-group">
														...
														<div class="row">
															<div class="xs-12 col-sm-12 col-md-6 col-lg-6">
																<div class="image">
                                                                    <img class="campimage" src="<?php echo $this->request->webroot; ?>images/campaign/<?php echo ($campaign['image'] != '') ? $campaign['image'] : 'no-image.jpg' ?>" alt="Image">
                                                                </div>
																<div class="btn-file">
													...
													<div class="form-group">
														...
														<input type="text" id="" class="form-control" name="youtube_link" value="<?php echo $campaign['youtube_link']; ?>" placeholder="Add a Youtube or Vimeo link">
													...
													<div class="form-group">
														...
														<textarea id="" class="form-control" name="aim" value="" placeholder="Enter project aim"><?php echo $campaign['aim']; ?></textarea>
													...
													<div class="form-group">
														...
														<textarea id="" class="form-control" name="story" value="" placeholder="Story..."><?php echo $campaign['story']; ?></textarea>
													...
													<div>
													<div class="form-group form-check form-radio">
														<input type="radio" id="" class="form-check-input" name="target" value="1" <?=$campaign['target'] == 1? "checked" : ""?>>
														<span class="custom-radio"></span>
														<label class="form-check-label">All or Nothing</label>
													</div>
													<div class="form-group form-check form-radio">
														<input type="radio" id="" class="form-check-input" name="target" value="2" <?=$campaign['target'] == 2? "checked" : ""?>>
														<span class="custom-radio"></span>
													...
													<div class="form-group">
														...
														<input type="number" min="1" step="0.01" id="" class="form-control" name="raise_amount" value="<?php echo $campaign['raise_amount']; ?>" placeholder="$0.00">
													...
													<div class="form-group">
														...
														<input type="number" min="1" step="0.01" id="" class="form-control" name="stretch_target" value="<?php echo $campaign['stretch_target']; ?>" placeholder="$0.00">
													...
													<div class="form-group">
														...
														<textarea id="" class="form-control" name="extra_money" value="" placeholder="Description..."><?php echo $campaign['extra_money']; ?></textarea>
													...
													<div class="form-group">
														...
														<input type="text" id="" class="form-control" name="keywords" value="<?php echo $campaign['keywords']; ?>" placeholder="Enter Keywords">
										...
										<div class="row">
											<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 m-auto">		
												<div class="form-wrap">
													...
													<div class="form-group form-check form-radio">
														<input type="radio" id="" class="form-check-input" name="perks" value="<?php echo $perk['id']; ?>" <?=$campaign['perks'] == $perk['id']? "checked" : ""?>>
														<span class="custom-radio"></span>
													...
													<div class="form-group">
														...
														<input type="date" id="" class="form-control" name="live" value="<?php echo $campaign['live']; ?>" placeholder="dd/mm/yyyy">
													...
													<?php foreach($deals as $deal){ ?>
														<div class="radio-inner">
															<input class="form-check-input" type="radio" name="deal_id" id="<?php echo $deal['name']; ?>" value="<?php echo $deal['id']; ?>" <?=$campaign['deal_id'] == $deal['id']? "checked" : ""?>>
